...
export default function App() {
  ...
  useEffect(() => {
    ...
    styleTag.innerHTML = `
      ...
      .cute-btn:hover {
        ...
        background: linear-gradient(90deg, #ff007f, #fffb00) !important;
        box-shadow: 0 0 35px #ff007f, 0 0 15px #fffb00 !important;
        cursor: pointer;
      }
    `
  ...
  function runAudit() {
    ...
    alert(`TOTAL DE MESAS FRAUDULENTAS: ${fraudulentTables.length}`)
  }
  ...
  return (
    <div style={styles.container}>
      ...
      {/* MARCA DE AGUA, PA LOS COPIONES LA MALA */}
...
const styles = {
  container: {
    background: 'radial-gradient(circle at top, #1c020f 0%, #080004 80%)',
    minHeight: '100vh',
    width: '100vw',
  ...
  card: {
    ...
    padding: '25px',
    boxSizing: 'border-box',
    boxShadow: '0 0 18px rgba(255, 251, 0, 0.25), inset 0 0 8px rgba(255, 251, 0, 0.05)',
    transition: '0.3s'
  },
  cardFraud: {
    border: '2px solid #ff007f',
    boxShadow: '0 0 25px rgba(255, 0, 127, 0.6), inset 0 0 10px rgba(255, 0, 127, 0.1)'
  },
  tableTitle: {
    color: '#ff007f',
    marginBottom: '15px',
  ...
  button: {
    background: 'linear-gradient(90deg, #fffb00, #ff007f)',
    color: '#080004',
    border: 'none',
    padding: '18px 45px',
    fontWeight: 'bold',
    ...
    letterSpacing: '2px',
    fontFamily: "'Orbitron', 'Courier New', monospace",
    boxShadow: '0 0 25px rgba(255, 0, 127, 0.5), 0 0 10px rgba(255, 251, 0, 0.3)',
    transition: '0.3s'
  },
  watermark: {
    position: 'fixed',
